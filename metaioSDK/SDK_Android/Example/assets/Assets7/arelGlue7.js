...

{
       ...
       arel.Scene.setTrackingConfiguration("TrackingData_GPSCompass.xml");
       ...
       metaioMan.setScale(new arel.Vector3D(1.0,1.0,1.0));
       ...
       var chair = arel.Object.Model3D.create("2","stuhl.obj","stuhl.jpg");
       chair.setVisibility(false);
       chair.setCoordinateSystemID(1);
       chair.setScale(new arel.Vector3D(10.0,10.0,10.0));
       ...
       var tv = arel.Object.Model3D.create("3","tv.obj","tv.png");
       tv.setVisibility(false);
       tv.setCoordinateSystemID(1);
       tv.setScale(new arel.Vector3D(10.0,10.0,10.0));
       ...
       var screen = arel.Object.Model3D.create("4","screen.obj");
       screen.setVisibility(false);
       screen.setCoordinateSystemID(1);
       screen.setScale(new arel.Vector3D(10.0,10.0,10.0));
       screen.setRotation(tvRotation);	   
	   screen.setMovie("sintel.3g2");	   
...

{
...

    {
		...
		// remvoe the geometries to the gesture handler
		...
		document.getElementById("manImage").src = "button_man_unselected.png";		
		document.getElementById("chairImage").src = "button_chair_unselected.png";		
		document.getElementById("tvImage").src = "button_tv_unselected.png";
...

{
...

    {
        ...
        {
            arel.Scene.getObject("1").setScale(new arel.Vector3D(1.0,1.0,1.0));
            arel.Scene.get3DPositionFromScreenCoordinates(new arel.Vector2D(0.5,0.5),1,function(trans){translationMan(trans);});
            document.getElementById("manImage").src = "button_man_selected.png";            
			manVisible = true;
...

{
    ...
    {	    
        ...
        {
            arel.Scene.getObject("2").setScale(new arel.Vector3D(10.0,10.0,10.0));
            arel.Scene.get3DPositionFromScreenCoordinates(new arel.Vector2D(0.5,0.5),1,function(trans){translationChair(trans);});
            document.getElementById("chairImage").src = "button_chair_selected.png";			
			chairVisible = true;
...

{
...

    {
        ...
        {
            arel.Scene.getObject("3").setScale(new arel.Vector3D(10.0,10.0,10.0));			
			arel.Scene.getObject("4").setScale(new arel.Vector3D(10.0,10.0,10.0));
            arel.Scene.get3DPositionFromScreenCoordinates(new arel.Vector2D(0.5,0.5),1,function(trans){translationTV(trans);});
            document.getElementById("tvImage").src = "button_tv_selected.png";			
			tvVisible = true;
